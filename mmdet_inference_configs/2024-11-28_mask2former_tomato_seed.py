...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        type='DetDataPreprocessor'),
    init_cfg=dict(
        checkpoint='model_weight/mask2former_tomato.pth', type='Pretrained'),
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='train/tomato_seed.json',
        backend_args=None,
        data_prefix=dict(img='tomato_seed/'),
        data_root='data/',
        pipeline=[
...
test_evaluator = dict(
    ann_file='data/train/tomato_seed.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
tomato_weight = 'model_weight/mask2former_tomato.pth'
...
work_dir = 'work_dirs/mask2former_r50_tomato_seed_pretrained'
