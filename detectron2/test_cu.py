...
# 🔹 데이터셋 정보
dataset_name = "cu_test"
json_path = "D:/plantdetection/detectron2/data/cu_test/dataset.json"
...
cfg.MODEL.WEIGHTS = "2023-09-20_1407_cucumber_300000.pth"  # 학습된 가중치
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 8  # 클래스 개수 고정
