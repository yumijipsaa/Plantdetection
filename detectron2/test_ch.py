...
# 🔹 데이터셋 정보
dataset_name = "ch_test"
json_path = "D:/plantdetection/detectron2/data/ch_test/dataset.json"
...
cfg.MODEL.WEIGHTS = "2023-11-01_1652_chilipepper_seed_50000.pth"  # 학습된 가중치
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 5  # 클래스 개수 고정
...
if __name__ == '__main__':
    ...
    image_paths = glob.glob(os.path.join(image_root, "data/ch_test", "*.jpg"))
    if not image_paths:
        print("❌ 추론할 이미지가 없습니다.")
        exit()
