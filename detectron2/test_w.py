...
# 🔹 데이터셋 정보
dataset_name = "w_test"
json_path = "D:/plantdetection/detectron2/data/w_test/dataset.json"
...
cfg.MODEL.WEIGHTS = "2024-11-15_whiteball_100000.pth"  # 학습된 가중치
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 1  # 클래스 개수 고정
