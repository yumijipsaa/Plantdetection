...
# 🔹 데이터셋 정보
dataset_name = "lett_test"
json_path = "D:/plantdetection/detectron2/data/lett_test/dataset.json"
...
cfg.MODEL.WEIGHTS = "2024-11-28_1447_lettuce_seed_130000.pth"  # 학습된 가중치
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 2  # 클래스 개수 고정
