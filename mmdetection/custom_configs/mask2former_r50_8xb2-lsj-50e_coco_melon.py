...
launcher = 'none'
load_from = 'work_dirs/mask2former_r50_8xb2-lsj-50e_coco_melon/epoch_9.pth'
log_level = 'INFO'
...
model = dict(
    ...
    test_cfg=dict(instance_on=True, panoptic_on=False),
    train_cfg=dict(
        assigner=dict(
            match_costs=[
...
work_dir = './work_dirs\\mask2former_r50_8xb2-lsj-50e_coco_melon'
